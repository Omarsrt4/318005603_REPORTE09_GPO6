...
glm::vec3 Posicion = glm::vec3(0);
glm::vec3 Direccion = glm::vec3(0);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// SpotLight
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), Posicion.x, Posicion.y, Posicion.z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), Direccion.x, Direccion.y, Direccion.z);
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		glUniform4f(glGetUniformLocation(lightingShader.Program, "colorAlpha"), 1.0, 1.0, 1.0, 10.0);
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 50.0f);
		...
		model = glm::rotate(model, glm::radians(Direccion.x), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(Direccion.y), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(Direccion.z), glm::vec3(0.0f, 0.0f, 1.0f));
